	...
	<div class="py-10 pt-[64px]">
		<div
			...
			<div class="flex flex-col w-full lg:w-2/4 gap-4">
				<div
					v-if="statsLoading"
					class="rounded-lg shadow-sm bg-white w-full p-4 flex justify-center items-center min-h-[200px]">
					<div
						class="animate-spin rounded-full h-12 w-12 border-b-2 border-gray-900"></div>
				</div>
					...
					<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
						<div class="bg-gray-50 rounded-lg p-4">
							<div class="flex items-center mb-2">
								...
								<h2 class="text-sm text-gray-500">标签数量</h2>
							</div>
						...
						<div class="bg-gray-50 rounded-lg p-4">
							<div class="flex items-center mb-2">
								...
								<h2 class="text-sm text-gray-500">分类数量</h2>
							</div>
							<p class="text-xl font-bold ml-1">
